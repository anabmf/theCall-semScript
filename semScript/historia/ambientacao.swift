...
let texto1_2 = "De repente, o alarme de incêndio! O salão explode em caos, com segurança tentando guiar os convidados para fora. Você permanece calma, mas se pergunta de onde veio o fogo enquanto deixa o museu com os outros. \nFora do salão, o policial Azevedo e o leiloeiro se aproximam."
let texto1_3 = "\u{001B}[33mPolicial Azevedo:\u{001B}[0m Boa tarde, Detetive Ana Lise. A obra de Van Gogh desapareceu no meio da confusão. Podemos contar com sua ajuda? \nVocê, incomodada pela interrupção, pondera. O sumiço de uma obra tão valiosa te inquieta.\n"
...
let texto2_4 = "\u{001B}[32mLeiloeiro duLance:\u{001B}[0m Ah, Detetive Ana Lise, uma tragédia! Incêndio e agora uma obra-prima sumida! Agradeço por aceitar o caso, minha reputação está em jogo! Eu estava no palco quando a sirene disparou. O estoque fica à direita do salão. Só eu e alguns funcionários temos acesso."
let texto2_5 = "\u{001B}[34mVocê:\u{001B}[0m E por que a família Cavalcanti está leiloando este quadro?"
let texto2_6 = "\u{001B}[32mLeiloeiro duLance:\u{001B}[0m A família tem grande histórico com arte. O quadro era de Benedito Cavalcanti, o famoso curador. A neta dele, Dalila Cavalcanti, trabalha comigo e trouxe a obra para o leilão sem dificuldades. Fique à vontade para investigar."
...
let opcao5_1 = "Conversa com suspeitos"
let opcao5_2 = "Explorar Casa"
let opcao5_3 = "Acusar suspeito Final"
...
let dialogo7 = Dialogo(
    ...
    opcoes: [
        Opcao(texto: opcao5_1, continuacao: dialogo8),
...
let dialogo5 = Dialogo(
    ...
    opcoes: [
        Opcao(texto: opcao5_1, continuacao: dialogo8),
        Opcao(texto: opcao5_2, continuacao: dialogo7),
        Opcao(texto: opcao5_3, continuacao: dialogo6),
    ]
)
...
let opcao_investigar_banheiro = Opcao(texto: opcao2_1, continuacao: dialogo3)
